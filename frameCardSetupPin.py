...
class FrameCardSetupPin(customtkinter.CTkFrame):
    def __init__(self, master):
        super().__init__(master)

        logger.debug("FrameCardSetupPin init")
        ...
        try:
            ...
            # confirm new PIN
            self.confirm_new_pin_label = master.create_label("Confirm PIN code:", frame=self)
            ...
            logger.error(f"An unexpected error occurred in FrameCardSetupPin init: {e}", exc_info=True)
